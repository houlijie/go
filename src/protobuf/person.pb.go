...
const (
	GenderType_UN GenderType = 0
	GenderType_M  GenderType = 1
	GenderType_F  GenderType = 2
)
...
type Person struct {
	...
	Gender GenderType `protobuf:"varint,3,opt,name=gender,proto3,enum=protobuf.GenderType" json:"gender,omitempty"`
}
...
func (x *Contect) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Contect) ProtoMessage() {}

func (x *Contect) ProtoReflect() protoreflect.Message {
	mi := &file_person_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Contect.ProtoReflect.Descriptor instead.
func (*Contect) Descriptor() ([]byte, []int) {
	return file_person_proto_rawDescGZIP(), []int{1}
}

func (x *Contect) GetPerson() []*Person {
	if x != nil {
		return x.Person
	}
	return nil
...
var file_person_proto_rawDesc = []byte{
	...
	,
...
var file_person_proto_goTypes = []interface{}{
	(GenderType)(0), // 0: protobuf.GenderType
	(*Person)(nil),  // 1: protobuf.Person
	(*Contect)(nil), // 2: protobuf.Contect
}
var file_person_proto_depIdxs = []int32{
	0, // 0: protobuf.Person.gender:type_name -> protobuf.GenderType
	1, // 1: protobuf.Contect.person:type_name -> protobuf.Person
